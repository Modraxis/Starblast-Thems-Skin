...
(function () {
    ...
    styleItem.appendChild(document.createTextNode(`body,html{background:var(--Dark-color)!important;color:var(--Main-color)!important;transition:background 0.5s,color .5s}.header{text-align:left!important;user-select:none!important;color:var(--Main-color)!important;font-size:1.3em!important;border-bottom:solid 2px var(--Light-color)!important;box-shadow:0 0 30px var(--Main-color)!important}.iconsbar.runiconsbar a,.sbg.sbg-fly-full,.sbg.sbg-help-full,#terminal div,.iconsbar{color:var(--Main-color)!important}.header div a{font-family:'Lato',sans-serif!important;border-radius:10px!important;font-size:.7em!important;color:var(--Main-color)!important;background:transparent!important}.header div a:hover{text-decoration:underline!important}.ace_content{border-right:1px solid var(--sec-Main-color)}#terminal{font-family:'Lato',sans-serif!important;text-align:left;background-color:var(--Dark-color);padding:20px;color:var(--Main-color);font-family:Monospace;font-size:10pt;background:var(--sec-Dark-color);box-shadow:0 0 10px 10px var(--sec-Main-color) inset!important;box-shadow:0 0 200px 0 var(--sec-Dark-color) inset!important;border-radius:8px!important}.cmd .cursor{background:var(--Main-color)!important}.terminal,.cmd,.terminal .terminal-output div div,.cmd .prompt{color:var(--Main-color)!important}.header h{position:absolute!important;top:30px}::-webkit-scrollbar-thumb{border-radius:20px!important;box-shadow:none!important;background:var(--sec-Main-color)!important}::-webkit-scrollbar{width:7px!important}::-webkit-scrollbar:horizontal{height:7px!important}::-webkit-scrollbar-track{box-shadow:none!important;border-radius:0!important;background-color:transparent!important}.ace_layer.ace_gutter-layer.ace_folding-enabled{background:var(--Dark-color)!important;color:var(--Main-color)!important}.fa.fa-fw{color:var(--Main-color)!important}.centerpanel label,.centerpanel a{border-radius:8px!important;background:var(--Dark-color)!important}select{font-family:Lato,Sans-Serif;font-size:1em;padding:3px 5px;color:var(--Main-color);background:var(--Dark-color);border:1px solid var(--Main-color);vertical-align:middle;outline:none;width:110px;border-radius:8px;box-sizing:border-box}.terminal-output div a{font-weight:700!important;color:var(--Main-color)!important;background:transparent!important;text-decoration:none!important}.terminal-output div a:hover{text-decoration:underline!important}.error{font-weight:700!important;border-bottom:2px dashed}[data-tooltip]:before{-webkit-border-radius:8px!important;-moz-border-radius:8px!important;border-radius:8px!important;background-color:var(--Dark-color)!important;color:var(--Main-color)!important;border:1px solid var(--Main-color)!important;content:attr(data-tooltip)!important}input[type="range"]{-webkit-appearance:none;appearance:none;background:transparent;border-radius:10px;outline:none}input[type="range"]::-webkit-slider-runnable-track{width:200px;height:5px;background:linear-gradient(to right,red,#0F0,blue,red);border-radius:5px}input[type="range"]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:10px;height:20px;background:var(--Main-color);cursor:pointer}input[type="range"]:focus::-webkit-slider-thumb,input[type="range"]:hover::-webkit-slider-thumb{background:var(--Main-color)}input[type="range"]:active::-webkit-slider-thumb{background:var(--Main-color)}fa.fa-fw.fa-forward.colors:before{content:"\f200"!important}#fieldview{border:1px solid var(--sec-Main-color)}`));
